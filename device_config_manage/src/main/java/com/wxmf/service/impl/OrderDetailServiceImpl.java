...
public class OrderDetailServiceImpl implements OrderDetailService {
    ...
    @Override
    public List<OrderDetail> getOrderDetailByOrderID(Integer orderID, Integer status) throws SQLException {
        List<OrderDetail> res = orderDetailDao.selectOrderDetailByOrderID(orderID, status);
        return res;
    }
}