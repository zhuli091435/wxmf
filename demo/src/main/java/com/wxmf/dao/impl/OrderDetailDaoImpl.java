...
public class OrderDetailDaoImpl implements OrderDetailDao {
    ...
    public int insertOrderDetail(OrderDetail orderDetail) throws SQLException {
        String sql = "insert into OrderDetail (ID, OrderID, CurPackageNumber, TotalPackageNumber, MsgType, MsgContent, MsgState, ExecuteCount, Sort) values (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        return queryRunner.update(sql, orderDetail.getID(), orderDetail.getOrderID(), orderDetail.getCurPackageNumber(), orderDetail.getTotalPackageNumber(), orderDetail.getMsgType(), orderDetail.getMsgContent(), orderDetail.getMsgState(), orderDetail.getExecuteCount(), orderDetail.getSort());
    }
